...
# Neynar Starter Kit Template

A Farcaster Mini Apps quickstart template.

This is a [NextJS](https://nextjs.org/) + TypeScript + React app.

_Note: this repository is meant for use by AI agents. Human users should call the [npx install script](https://github.com/neynarxyz/create-farcaster-mini-app) `npx @neynar/create-farcaster-mini-app`._
